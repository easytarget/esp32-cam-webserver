...
const selectOptions = [{"field": "framesize", 
                        "options": [{"id": 0, "name": "THUMB (96x96)"},
                                     {"id": 1, "name": "QQVGA (160x120)"},
                                     {"id": 3, "name": "HQVGA (240x176)"},
                                     {"id": 3, "name": "HQVGA (240x176)"},
                                     {"id": 5, "name": "QVGA (320x240)"},
                                     {"id": 6, "name": "CIF (400x296)"},
                                     {"id": 7, "name": "HVGA (480x320)"},
                                     {"id": 8, "name": "VGA (640x480)"},
                                     {"id": 9, "name": "SVGA (800x600)"},
                                     {"id": 10, "name": "XGA (1024x768)"},
                                     {"id": 11, "name": "HD (1280x720)"},
                                     {"id": 12, "name": "SXGA (1280x1024)"},
                                     {"id": 13, "name": "UXGA (1600x1200)"},
                                     {"id": 14, "name": "FHD (1920x1080)"},
                                     {"id": 17, "name": "QXGA (2048x1536)"}]},
                        {"field": "frame_rate",
...
var cameraFormFields = [{"id": "lamp", "name": "Light", "control": "range",
                           ...
                           "title":"When enabled the lamp will only turn on while the camera is active",
                           "classes": "default-action", "simple":"true"},
                           ...
                           "classes": "default-action", 
                           "simple":"true"},
                           {"id": "xclk", "name": "XCLK", "control": "text",
